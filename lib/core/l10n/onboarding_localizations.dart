...
/// Локализованные строки онбординга (4 языка).
const onboardingLocalizations = <String, Map<String, String>>{
  ...
  OnboardingStringKeys.eulaBody: {
    'ru':
        'Настоящее Пользовательское соглашение регулирует использование мобильного приложения Sunlight Jewelry. Используя приложение, вы подтверждаете согласие с правилами сервиса, условиями покупки ювелирных изделий, политикой возврата и обслуживания клиентов.',
    'ko':
        '본 이용약관은 Sunlight Jewelry 모바일 애플리케이션 이용을 규정합니다. 앱을 사용함으로써 귀하는 서비스 이용 규칙, 주얼리 구매 조건, 반품 및 고객 지원 정책에 동의하게 됩니다.',
    'en':
        'This EULA governs the use of the Sunlight Jewelry mobile application. By using the app, you agree to service rules, jewelry purchase terms, return policy, and customer support standards.',
    'uz':
        'Ushbu foydalanuvchi shartnomasi Sunlight Jewelry mobil ilovasidan foydalanishni tartibga soladi. Ilovadan foydalanish orqali siz xizmat qoidalari, zargarlik buyumlarini sotib olish shartlari va qaytarish siyosatiga rozilik bildirasiz.',
  },
